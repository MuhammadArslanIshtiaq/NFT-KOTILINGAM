...
const AboutSection = () => {
  return (
    <section id='about' className='py-8 md:py-16 relative bg-ebony z-30'>
            ...
            <div className='mb-12 sm:text-center'>
              ...
              <h6 className=' text-[1rem] font-normal'>
                <div className='mt-4'>
                  ...
                  collection of 10 Million Lingams will be minted into 7K NFTs
                  in Ethereum block chain. 5000 NFTs will be releases in Phase
                  1.
                </div>
                ...
                <div className='mt-4'>
                  Each owner of the Kotilingam will become called “KOTI” and
                  will be part of the Kotilingam community where they will enjoy
                  exclusive benefits like access to major events like Yoga,
                  Meditation, Retreats, music festivals, conferences and
                  concerts. Some of them will receive a Golden Key to the
                  Metaverse where they can avail exclusive benefits.
                </div>
